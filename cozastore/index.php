                ...
                <div class="content-topbar flex-sb-m h-full container">
                    ...
                    <div class="right-top-bar flex-w h-full">
                        ...
                        if(isset($_SESSION['auth']['name']) == "name"){
                            ...
                            src="./administration/<?php echo ($_SESSION['auth']['avatar']) ?>" width="30" height="30">
                            <?php
                            echo "<a style='color: #ddd;padding: 0 25px 0 0px;' class='flex-c-m trans-04 p-lr-25'>".($_SESSION['auth']['name']."</a>");


                            if(($_SESSION['auth']['role']) == 1){
                                echo " <a href='administration'  class='flex-c-m trans-04 p-lr-25'> Quản trị</a>";
                            }
                            echo " <a href='dangnhap/logout.php' class='flex-c-m trans-04 p-lr-25'> Đăng xuất </a>";

                        }else{
                        
                            echo "<a href='dangnhap/login.php' class='flex-c-m trans-04 p-lr-25'>Đăng nhập</a>";
                            echo "<a href=''dangnhap/dk.php' class='flex-c-m trans-04 p-lr-25'>Đăng kí</a>";
                        }?>
